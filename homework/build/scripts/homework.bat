...
set CLASSPATH=%APP_HOME%\lib\homework.jar;%APP_HOME%\lib\testng-6.10.jar;%APP_HOME%\lib\jcommander-1.48.jar

@rem Execute homework
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HOMEWORK_OPTS%  -classpath "%CLASSPATH%" ru.stqa.pft.homework.MainHomeWork %CMD_LINE_ARGS%
